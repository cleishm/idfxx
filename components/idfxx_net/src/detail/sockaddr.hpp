...
/// Convert an idfxx::net::address_family to a POSIX AF_* constant. Returns
/// AF_UNSPEC for std::nullopt.
[[nodiscard]] int family_to_af(std::optional<address_family> f) noexcept;
