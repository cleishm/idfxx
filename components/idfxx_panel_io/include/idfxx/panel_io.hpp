...
/**
 * @headerfile <idfxx/panel_io>
 * @file panel_io.hpp
 * @brief Display panel I/O class.
 *
 * @defgroup idfxx_panel_io Panel I/O Component
 * @brief Panel I/O interface for SPI- and I2C-connected displays.
 *
 * Provides the communication layer for SPI- and I2C-connected display panels
 * (LCD, OLED, and ePaper) and touch controllers.
 *
 ...
 * @brief Panel I/O interface for SPI- and I2C-connected displays.
 *
 * Provides the communication layer for display panels (LCD, OLED, ePaper)
 * and touch controllers that use SPI or I2C. This type is non-copyable and
 * move-only. A moved-from object must not be used: any operation other than
 * destruction or assignment is undefined behavior.
 */
class panel_io {
public:
    /**
