 ...
 * @brief C++ wrapper for ESP-IDF SPI master driver.
 *
 * Provides RAII-based SPI bus lifecycle management with support for
 * DMA transfers and integration with the ESP-IDF SPI device API.
 *
