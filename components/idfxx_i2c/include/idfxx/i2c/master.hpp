 ...
 * @brief C++ wrapper for ESP-IDF I2C master driver.
 *
 * Provides RAII-based I2C bus lifecycle management with thread-safe
 * device access, register operations, and dual error handling supporting
 * both exceptions and result types.
 *
