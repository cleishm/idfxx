...
// Unit tests for idfxx nvs wrapper
...
TEST_CASE("nvs::make with valid namespace succeeds", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs::make with read_only flag", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs::make with invalid namespace name fails", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs set and get string", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs get non-existent key returns not_found", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs set and get blob", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs set and get blob with raw pointer", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs set and get integer values", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs erase key", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs erase non-existent key returns not_found", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs erase_all", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs read-only handle cannot write", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs type mismatch error", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs key too long error", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs empty string value", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
...
TEST_CASE("nvs empty blob value", "[idfxx][nvs][hw]") {
    ensure_nvs_init();
